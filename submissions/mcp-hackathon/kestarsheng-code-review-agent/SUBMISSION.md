...
```json
// GET /health
{"status":"ok","commit":"1afce87"}
```

```json
// GET /.well-known/xagent-verification.json
{"schemaVersion":1,"slug":"kestarsheng-code-review-agent","commit":"1afce87"}
```
...
- **Health-check result:** `{"status":"ok","commit":"1afce87..."}`
